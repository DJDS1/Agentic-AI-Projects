...
Not a Licensed Financial Advisor. The analysis, trade ideas, bias scores, and portfolio strategies presented in this material were generated using artificial intelligence tools and do not represent the views or recommendations of a registered investment advisor, broker-dealer, commodity trading advisor (CTA), or any other licensed financial professional. Always consult a qualified financial advisor before making any investment or trading decisions.
Simulated Performance is Not Indicative of Future Results. The trade log, equity curves, ROI figures, and portfolio statistics shown in this presentation are based entirely on simulated data generated through a statistical model. Simulated or hypothetical performance results have certain inherent limitations: they do not reflect actual trading, they do not account for slippage, bid-ask spreads, brokerage commissions, margin requirements, overnight financing costs, or market impact. Actual results will differ materially from simulated results.
Past Performance Does Not Guarantee Future Results. Even where reference is made to actual historical market conditions (price levels, yield data, technical indicators as of May 2026), the application of any strategy to those conditions in hindsight does not guarantee that the same strategy will produce profitable results going forward.
Futures Trading Involves Substantial Risk of Loss. Trading futures contracts — including equity index futures (ES, NQ, YM), metals futures (GC, SI), energy futures (CL, NG), and Treasury futures (ZB, ZN, ZF) — involves a high degree of risk and is not suitable for all investors. The use of leverage can work against you as well as for you. You could lose more than your initial investment. Only risk capital you can afford to lose entirely.
No Guarantee of ROI Target. The >20% annual return on investment target referenced throughout this presentation is a stated goal, not a guaranteed outcome. Market conditions, execution quality, individual discipline, and unforeseen events will all affect actual performance. There is no assurance that any strategy described herein will achieve its stated objectives.
AI-Generated Content. This material was produced with the assistance of Claude, an AI system developed by Anthropic. AI-generated analysis may contain errors, omissions, or outdated information. All data, price levels, and technical analysis should be independently verified before use in live trading.
No Liability. The author, presenter, and any affiliated parties accept no liability for any losses, damages, or costs arising directly or indirectly from the use of, or reliance on, any information contained in this presentation.
